...
public class MedicineAlarm extends Activity {
    ...
    private void initializeApp() {
        ...
        br = new BroadcastReceiver() {
            ...
            public void onReceive( Context context, Intent intent ) {
                ...
                //Toast.makeText(this,"Wake UP: " + notes ,Toast.LENGTH_LONG).show();
                //toastIt( );
        ...
        registerReceiver( br, new IntentFilter( "com.abcd.projetcnam.MedicineAlarm") );
    ...
    public void toggleAlarm( View v ) {
        if( v.getId() == toggleButton1.getId() ) {
            if( toggleButton1.isChecked() ) {
                ...
                Toast.makeText(this,"Alarm On: " + alarms[0],Toast.LENGTH_LONG).show();
                //toastIt( "Alarm On: " + alarms[0] );

            } else {
                Toast.makeText(this,"Alarm Off: " + editNotes1.getText().toString(),Toast.LENGTH_LONG).show();
            ...
            if( toggleButton2.isChecked() ) {
                ...
                Toast.makeText(this,"Alarm On: " + alarms[1],Toast.LENGTH_LONG).show();
